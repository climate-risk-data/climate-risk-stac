...
csv = data.frame(
  ...
  title_item = "GHS-POP WGS84 3 arc seconds",
  description_item = "GHS-POP in WGS84 coordinates and a spatial resolution of 3 arc seconds.",
  item_id = 1, #if several datasets listed from the same overall dataset (i.e. collection)
  ...
  assets = "https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/GHS_POP_GLOBE_R2023A/GHS_POP_E1975_GLOBE_R2023A_4326_3ss/V1-0/GHS_POP_E1975_GLOBE_R2023A_4326_3ss_V1_0.zip" 
  #*; here: example file for 1975
)

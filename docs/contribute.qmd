...
To make this a ***living*** catalog, it needs to be continuously updated and expanded by its users. We therefore encourage all users to **report inconsistencies, missing information, or malfunctions, and to **contribute new or missing datasets**, which can be submitted via [GitHub Issues](https://github.com/climate-risk-data/climate-risk-stac/issues/new/choose). 
...
![](./images/issues.png){width=80% fig-align="center"}

<br>

4.	Select the relevant category by clicking on the **"Get started"** button:

![](./images/issue_templates.png){width=80% fig-align="center"}

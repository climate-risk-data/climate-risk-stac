...
![STAC Browser visualization at the item level. Example of the item 'Index 0.1 dec deg' in collection 'Critical Infrastructure Spatial Index (CISI)' (web browser used: Mozilla Firefox)](./images/item.png)
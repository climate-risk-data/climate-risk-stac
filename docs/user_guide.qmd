...
![](./docs/images/1st_catalogs.png){width=80%}
...
![Screenshot of the STAC Browser visualization at the collection level. Example of the collection 'Critical Infrastructure Spatial Index (CISI)' in catalog 'Exposure-vulnerability' - 'Infrastructure' (web browser used: Mozilla Firefox](./docs/images/collection.png){width=90%}
<br>
...
![STAC Browser visualization at the item level. Example of the item 'Index 0.1 dec deg' in collection 'Critical Infrastructure Spatial Index (CISI)' (web browser used: Mozilla Firefox)](./docs/images/item.png){width=90%}